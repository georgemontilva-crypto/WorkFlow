  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[9999px] text-sm font-medium transition-colors-smooth disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-[#C4FF3D]/30",
  {
    variants: {
      variant: {
        ...
        default: "border border-[#C4FF3D] bg-transparent text-[#C4FF3D] hover:bg-[#C4FF3D]/10 hover:border-[#D4FF6D] hover:shadow-[0_0_12px_rgba(196,255,61,0.4)]",
        
        // Destructive: outline rojo, sin fondo
        destructive: "border border-[#EF4444] bg-transparent text-[#EF4444] hover:bg-[#EF4444]/10 hover:border-[#F87171] hover:shadow-[0_0_8px_rgba(239,68,68,0.3)]",
        
        // Secondary: outline gris, sin fondo
        secondary: "border border-[#9AA0AA] bg-transparent text-[#9AA0AA] hover:bg-[#9AA0AA]/10 hover:border-[#B0B6C0]",
        
        // Warning: outline amarillo, sin fondo
        warning: "border border-[#F59E0B] bg-transparent text-[#F59E0B] hover:bg-[#F59E0B]/10 hover:border-[#FBBF24] hover:shadow-[0_0_8px_rgba(245,158,11,0.3)]",
      ...
      size: {
        ...
        icon: "min-w-[44px] min-h-[44px] size-10 border rounded-[9999px]",
        "icon-sm": "min-w-[36px] min-h-[36px] size-8 border rounded-[9999px]",
        "icon-lg": "min-w-[48px] min-h-[48px] size-12 border rounded-[9999px]",
      },
    },
    defaultVariants: {
      variant: "default",
