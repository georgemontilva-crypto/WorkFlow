      ...
      <div className="max-w-[1440px] mx-auto px-2 py-4 md:p-6 space-y-4 md:space-y-6 overflow-x-hidden">
        ...
        <Card>
          ...
          <Dialog open={isDialogOpen} onOpenChange={(open) => {
            ...
            <DialogContent className="bg-[#0a0a0a] border-white/10 max-w-lg max-h-[calc(100vh-9rem)] md:max-h-[90vh] overflow-y-auto overflow-x-hidden">
              <DialogHeader>
                    ...
                    {goal.status !== 'completed' && remaining > 0 && (
                      <div className="flex items-center justify-between pt-1">
                        ...
                        <Button
                          ...
                          variant="outline"
                          size="icon"
                          className="w-10 h-10 rounded-full flex-shrink-0 border border-[#C4FF3D] text-[#C4FF3D] hover:bg-[#C4FF3D]/10"
                          title="Agregar monto"
                        >
                          <TrendingUp className="w-5 h-5" />
                        </Button>
